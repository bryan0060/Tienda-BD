...
export class ProductoService {
  ...
  private inicializarProductos(){
    const producto1 = new Producto(this.idSiguiente++, 'Gaseosa Coca-Cola', 130.0, 0);
    const producto2 = new Producto(this.idSiguiente++, 'Jabón REY', 80.0, 0);
    const producto3 = new Producto(this.idSiguiente++, 'Suavitel 500ML', 50.0, 0);
